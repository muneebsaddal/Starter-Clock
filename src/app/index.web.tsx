...
const styles = StyleSheet.create({
  ...
  jar: { width: 230, height: 300, borderWidth: 2, borderColor: "#8C7B68", borderRadius: 8, backgroundColor: "#E8B06F", justifyContent: "flex-end", alignItems: "center", paddingBottom: 26, boxShadow: "0 16px 22px rgba(58, 43, 32, 0.18)" },
  ...
  previewPanel: { position: "absolute", right: 16, bottom: 18, width: 216, borderRadius: 8, borderWidth: 1, borderColor: "#D8CCBB", backgroundColor: "#FFFDF8", padding: 18, boxShadow: "0 10px 18px rgba(58, 43, 32, 0.14)" },
